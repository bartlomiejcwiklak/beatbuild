...
export default function AlbumCarousel({ albums, selectedIndex, onSelect }) {
  ...
  const moveDrag = (clientX) => {
    ...
    // Weighted moving average prevents release spikes from tiny jitter.
  ...
  return (
    <div className="album-picker">
      ...
      <div className="carousel-stage">
        ...
        >
          <div
            className={`jewel-case ${transitionClass}`}
            style={cdStyle}
          >
