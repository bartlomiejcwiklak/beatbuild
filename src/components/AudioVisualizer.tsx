...
export default function AudioVisualizer({ analyser, isPlaying, themeHue, themeSaturation }: AudioVisualizerProps) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const activeIntensity = isPlaying ? Math.max(0.05, beatIntensity) : 0.05;
